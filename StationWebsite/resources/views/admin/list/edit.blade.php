...
<form action="{{url('admin/list/doEdit')}}" method="post" id="form" enctype="multipart/form-data">
    @csrf
    <ul class="index_ul">
        ...
        <li class="index_line">
            <span class="index_name">列表名称</span> :
        ...
        <li class="index_line">
            ...
            <select name="template" >
                @foreach($template as $vo)
                    @if($data!=''&&$data->template_id==$vo->id)
                        <option value="{{$vo->id}}" selected>{{$vo->nickname}}</option>
                    @else
    ...
    <div style="text-align: center">
        ...
        <a class="back" href="/admin/list/info?table=type_of_list&type={{$type}}">取消</a>
    </div>
