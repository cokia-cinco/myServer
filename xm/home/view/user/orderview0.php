                    ...
                    <div class="uc-content-box">
                        <div class="box-hd">
                            ...
                            <div class="more">
                                ...
                                <div class="actions">
                                    <a class="btn-small btn" href="index.php?c=order&a=cancel&id=<?=$id1?>&status=<?=$status?>">取消订单</a>
                                    <a style="color: #fff;background-color: #ff6700;" class="btn-small btn" href="index.php?c=order&a=wait&id=<?=$id1?>&status=<?=$status?>">立即付款</a>
                                </div>
                            </div>
                                    ...
                                    <div class="order-summary">
                                        ...
                                        <table class="order-item-table">
                                            <tbody>
                                                ...
                                                <!--一个商品订单-->
                                                <?php foreach ($arrayName as $key => $value1): ?>
                                                    <?php foreach ($value1['goods'] as $key => $value2): ?>
                                                        <tr>
                                                            <td class="col col-thumb">
                                                                <div class="figure-thumb">
                                                                    <a href="">
                                                                        <img src="<?= imgPath(UPLOAD, $value2['iname'])?>" alt="">
                                                                    </a>
                                                                </div>
                                                            </td>
                                                            <td class="col col-name">
                                                                <p class="name">
                                                                    <a href=""><?=$value2['gname']?></a>
                                                                </p>
                                                                
                                                            </td>
                                                            <td class="col col-price">
                                                                <p class="price"><?=$value2['price']?>元</p>
                                                            </td>
