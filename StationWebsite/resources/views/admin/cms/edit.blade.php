...
<form action="{{url('admin/cms/doEdit')}}" method="post" id="form" enctype="multipart/form-data">
    @csrf
    <ul class="index_ul">
        <input type="hidden" name="id" value="{{$data==''?'':$data->id}}">
        <input type="hidden" name="table" value="{{$table}}">
        <li class="index_line">
            <span class="index_name">作者</span> :
            <input class="index_value" type="text" name="author" value="{{$data==''?'':$data->author}}">
        </li>
        <li class="index_line">
            <span class="index_name">标题</span> :
            <input class="index_value" type="text" name="title" value="{{$data==''?'':$data->title}}">
        </li>
        @if($table=='news')
        <li class="index_line">
            <span class="index_name">图片</span> :
            <input class="local_img" type="file" name="img">
            <input type="hidden" class="imgList" name="imgList" value="{{$data==''?'':$data->img}}">
    ...
    <div style="text-align: center">
        ...
        <a class="back" href="/admin/cms/info?table={{$table}}">取消</a>
    </div>
</form>
