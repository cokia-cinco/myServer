...
<head>
    ...
    <link href="<?=HOME_CSS?>unpaid.css" rel="stylesheet">
                        ...
                        <div class="box-hd">
                            ...
                            <div class="more">
                                <ul class="filter-list">
                                    ...
                                    <li>
                                        <a style="color: #ff6700;" href="index.php?c=user&a=waiting">待收货
                                            <?php
                                            ...
                                            <table class="order-detail-table">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="order-item">
                                                            <ul class="goods-list">
                                                                <?php foreach ($value['goods'] as $key => $valuea): ?>
                                                                   
                                                                        <li>
                                                                        <div class="figure-thumb">
                                                                            <a href="">
                                                                                <img src="<?= imgPath(UPLOAD, $valuea['iname'])?>" alt="">
                                                                            </a>
                                                                        </div>
                                                                
                                                                 
                                                                      <p class="name">
                                                                            <a href=""><?=$valuea['gname']?></a>
                                                                        </p>
                                                               
                                                                       
                                                                        <p class="price"><?=$valuea['price']?>元 x <?=$valuea['qty']?></p>
                                                                    </li>
                                                        ...
                                                        <td class="order-actions">
                                                            <!-- <a style="background-color: #ff6700 !important;color:#fff !important" class="btn-small" href="index.php?c=order&a=wait&status=<?=$value['status']?>&id=<?=$value['id']?>">立即付款</a> -->
                                                            <a class="btn-small" href="index.php?c=order&a=orderview0&status=<?=$value['status']?>&id=<?=$value['id']?>">订单详情</a>
                                                            <a class="btn-small" href="index.php?c=order&a=receipt&id=<?=$value['id']?>&status=<?=$value['status']?>">确认收货</a>
                                                        </td>
                                                    </tr>
