...
<head>
    ...
    <link href="<?=HOME_CSS?>order.css" rel="stylesheet">
                            ...
                            <div class="more">
                                <ul class="filter-list">
                                    <li style="padding-left: 0;border-left: none">
                                        <a style="color: #ff6700;" href="index.php?c=user&a=order">全部有效订单</a>
                                    </li>  
                                    <li>
                                    ...
                                    <li>
                                        <a href="index.php?c=user&a=waitgoods">待发货
                                             <?php
                            ...
                            <div class="order-List">
                                <ul class="order-list">
                                    <?php if (empty($arrayName)): ?>
                                        <div>
                                            <p style="margin:40px 0 ;text-align: center;color:#b0b0b0;font-size: 18px;">当前没有订单</p>
                                        </div>
                                    <?php else: ?>
                                    ...
                                    <li class="uc-order-item">
                                        <div class="order-remove">
                                            <?php if ($value['status']=='3'||$value['status']=='6'): ?>
                                                <a href="index.php?c=order&a=del&id= <?=$value['id']?>"><img src="<?=HOME_IMG?>order/trash.png" alt=""></a>
                                            <?php endif ?>
                                            ...
                                            <div class="order-summary">
                                                <div class="order-status">
                                                    <?php if ($value['status']==0): ?>
                                                        <p style="color:#ff6700">待支付</p>
                                                    <?php elseif($value['status']==1): ?>
                                                        <p style="color:#83c44e">待发货</p>
                                                    <?php elseif($value['status']==2): ?>
                                                        <p style="color:#83c44e">待收货</p>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td class="order-actions">
                                                            <a class="btn-small" href="index.php?c=order&a=orderview&id=<?=$value['id']?>&status=<?=$value['status']?>">订单详情</a>
                                                            <?php if ($value['status']==0): ?>
                                                                <a style="color:#fff;background-color: #ff6700;border:1px solid #ff6700" class="btn-small" href="">立即付款</a>

                                                            <?php elseif($value['status']==2): ?>
                                                                <a class="btn-small" href="">确认收货</a>
                                                            <?php elseif($value['status']==3): ?>
