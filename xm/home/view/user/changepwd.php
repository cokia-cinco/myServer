            ...
            <div class="span16">
                <div class="uc-main-box">
                    <div class="uc-content-box">
                        ...
                        <div class="box-bd">
                            <form action="index.php?c=user&a=changepass" method="post">
                                <input name='id' type="hidden" value="<?=$_SESSION['home']['id']?>">
                                <dl>
                                    <dt>原密码</dt>
                                    <dd>
                                        <input name="pwd" type="password" placeholder="输入原密码">
                                    </dd>
                                    <dt>新密码</dt>
                                    <dd>
                                        <input name="pass" type="password" placeholder="输入新密码">
                                        <input name="repass" type="password" placeholder="重复新密码">
                                    </dd>
                                </dl>
                                <input type="submit">
                            </form>
