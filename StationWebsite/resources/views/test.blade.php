                    ...
                    <div class="edge_t wrap">
                        <div class="left l_logo">
                            <a href="m/index.html" class="edge_logo">
                                <img src="res/m/image/common/logo.png" alt="">
                            </a>
                        </div>
                    </div>
                </div>
                <ul class="edge_b overHide">
                    <li class="item active"><a href="/?name=index&type=m">首页</a></li>
                    <li class="item "><a href="/?name=export&type=m">出口服务</a></li>
                    <li class="item "><a href="/?name=import&type=m">进口服务</a></li>
                    <li class="item "><a href="/?name=financial&type=m">金融服务</a></li>
                    <li class="item "><a href="/?name=about&type=m">关于我们</a></li>
                </ul>
            </div>
        </nav>
    @show
...
<!--foot start-->
    <div id="footer" class="overHide foot wrap">
        ...
        <div class="f_6 overHide">
            <p class="f_t6">版权所有 ©2009-2019<br>{{$config->info}}</p>
        </div>
    </div>
    <!--foot end-->
</main>
