                    ...
                    <div class="uc-content-box">
                        <div class="box-hd">
                            ...
                            <div class="more">
                                ...
                                <div class="actions">
                                    <a class="btn-small btn" href="index.php?c=order&a=cancel&id=<?=$id?>&status=<?=$status?>">取消订单</a>
                                    <!-- <a style="color: #fff;background-color: #ff6700;" class="btn-small btn" href="">待收货</a> -->
                                </div>
                            </div>
