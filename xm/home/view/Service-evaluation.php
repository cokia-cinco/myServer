...
<head>
    <meta charset="UTF-8">
    <title>商品评价</title>
    <link href="css/Service-evaluation.css" rel="stylesheet">
                                ...
                                <div class="cont-top">
                                    ...
                                    <div class="top-r">
                                        <div class="right-text">
                                            <textarea name="" id="" cols="30" rows="10" maxlength="500" placeholder="还有想说的吗？您的意见对我们非常重要" style="height: 137px"></textarea>
                                            <svg class="icon" aria-hidden="true">
                                ...
                                <div class="cont-content">
                                    <div class="comment-common">
                                        <div class="common-left">
                                            <img src="img/comment/pms_1560238127.40319869.png" alt="">
                                            <div class="title">
                                                小米手环4 NFC版 黑色
                                            </div>
                                        </div>
                                        <div class="common-right">
                                            ...
                                            <div class="right-middle">
                                                <textarea class="middle-text" maxlength="500" name="" id="" cols="30" rows="10" placeholder="外形如何？品质如何？写写你的感受分享给网友吧！"></textarea>
                                                <div class="words">
                                                    0/500
                                                </div>
