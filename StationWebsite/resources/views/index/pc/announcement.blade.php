...
<div class="breadBox">
        <ul class="wrap breadCrumb2">
            <li class="bt active"><a href="/">首页</a>&gt;<a href="/?name=announcement">媒体中心</a></li>
        </ul>
    </div>
@if(is_null($id))
            ...
            <ul class="choseBox">
                <li class="ci cMsg  active">
                    <div class="toggle_a" id="t_msg">                
                            <a href="/?name=news"  class="chose_i  ">新闻</a>        
                            <a href="/?name=announcement" class="chose_i active">公告</a>
                    </div>
                    <div class="medias">
                    <ul>
                         @foreach($all_announcement as $announcement)
                            <li class="mLis row2">
                    				...
                    				<a target="_blank" style="font-size:1.2rem;" href="/?name=announcement&id={{$announcement->id}}">
                    				    {{$announcement->title}}
                				        </a>
            			            </p>
                            		    <p class="right time1">
                            				{{explode(' ',$announcement->time)[0]}}
                            		    </p>
        		      </li>
                        @endforeach    
                    </ul>
