...
<head>
    ...
    <link href="<?=HOME_CSS?>recycle.css" rel="stylesheet">
                        ...
                        <div class="box-hd">
                            ...
                            <div class="more">
                                <ul class="filter-list">
                                    ...
                                    <li>
                                        <a style="color: #ff6700;" href="index.php?c=user&a=recycle">订单回收站</a>
                                    </li>  
                            ...
                            <div class="order-List">
                                <ul class="order-list">
                                    <?php if (empty($arrayName)): ?>
                                        <div>
                                            <p style="margin:40px 0 ;text-align: center;color:#b0b0b0;font-size: 18px;">当前没有已删除订单</p>
                                        </div>
                                    <?php else: ?>
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td class="order-actions">
                                                                    ...
                                                                    <a class="btn-small" href="index.php?c=order&a=restore&id=<?=$value['id']?>">还原订单</a>
                                                                </td>
                                                            </tr>
