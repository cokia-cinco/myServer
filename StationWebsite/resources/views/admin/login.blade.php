...
<body class="login-bg" style="background:url(/image/admin/bg.png) center 0px/100%  no-repeat">

    <div class="login layui-anim layui-anim-up">
        <div class="message">网站管理登录</div>
        <div id="darkbannerwrap"></div>

        <form method="post" class="layui-form" action="/login/admin">
            @csrf
