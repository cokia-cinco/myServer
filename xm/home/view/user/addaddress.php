            ...
            <div class="span16">
                <div class="uc-main-box">
                    <div class="uc-content-box">
                        ...
                        <div class="box-bd">
                            <form action="index.php?c=address&a=addaddress" method="post">
                                <div class="form-section">
                                    <input class='input1' type="text" name='name' placeholder="收货人姓名">
                                </div>
                                <div class="form-section">
                                    <input class='input1' type="text" name='phone' placeholder="手机号">
                                </div>
                                <div class="form-section">
                                    <input class='input2' type="text" name='province' placeholder="省份">
                                </div>
                                <div class="form-section">
                                    <input class='input2' type="text" name='city' placeholder="市区">
                                </div>
                                <div class="form-section">
                                    <input class='input2' type="text" name='county' placeholder="区县">
                                </div>
                                <div class="form-section">
                                    <input class='input2' type="text" name='street' placeholder="街道">
                                </div>
                                <div class="form-section">
                                    <input class='input3' type="text" name='address' placeholder="详细地址">
                                </div>

                                <div class="form-section">
                                    <input class='input1' type="text" name='postcode' placeholder="邮政">
                                </div>
                                <div class="form-section">
                                    <input class='input1' type="text" name='label' placeholder="地址标签">
                                </div>
