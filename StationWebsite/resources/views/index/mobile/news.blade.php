            ...
            <ul class="choseBox">
                <li class="ci cMsg  active">
                    <div class="toggle_a" id="t_msg">                        
                        <a href="/?name=news&type=m" class="chose_i active">新闻</a>
                        <a href="/?name=announcement&type=m" class="chose_i ">公告</a>
                    </div>
                ...
                <ul>
                    ...
                    <li class="mLis row2">
                        <p class="left p1" >
                            ...
                            <a target="_blank" href="/?name=news&type=m&category=news&id={{$item->id}}">
                            {{$item->title}}
                            </a>
                        </p>
                        <p class="right time1">
